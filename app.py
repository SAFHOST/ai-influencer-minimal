...
def create_influencer_page(manager):
    ...
    with st.form("influencer_form"):
        ...
        with col2:
            ...
            target_audience = st.multiselect("Target Audience", ["Gen Z", "Millennials", "Professionals", "Students"])
        
        if st.form_submit_button("🚀 Create AI Influencer", type="primary"):
            if not name:
...
# This is the CORRECT way to call main
